...
<head>
  ...
  <title>Login | Sistem Informasi Pendaftaran Unit Kegiatan Mahasiswa</title>
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <!-- /.social-auth-links -->
        <div class="row">
          <div class="col-12">
            <center><p>Belum Punya akun? <a href="register" class="text-justify">Daftar Disini</a></p></center>
          </div>
        </div>
      </div>
    </div>
