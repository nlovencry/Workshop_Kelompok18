...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><img src="ukm/gambar/logo-gabung.png"></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          if (isset($_SESSION['status'])){
            ...
            ?>
            <li><a href="ukm/mahasiswa/profile-mhs">Halo <?php echo $_SESSION['username']; ?></a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-10 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="d-lg-flex">
            <a href="ukm/panduan-daftar" class="btn-get-started scrollto">Panduan Daftar</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-links">
            <img src="ukm/gambar/logo-gabungan.png" width="350" height="180">
          </div>
        </div>
      </div>
    </div>
