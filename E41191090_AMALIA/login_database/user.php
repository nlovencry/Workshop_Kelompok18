...
<!-- area chart -->
        ...
        <h6 class="m-0 font-weight-bod text-primary">User</h6>
        ...
        <input type="text" class="form-control form-control-user" id="name" name="name" placeholder="id" required>
        </div>
        <div class="form-group">
        ...
        if ($password){
            echo "<srong>Password:</strong> {$password} <br>";
        }
        ?>
        </form>
        </div>
