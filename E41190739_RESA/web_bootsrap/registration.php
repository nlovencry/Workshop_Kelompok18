              ...
              <div class="col-xl-12 col-lg-7">
                ...
                <div class="card-body">
                  <form>
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-use" id="user" name="user" placeholder="Username Anda" required>
                    </div>
                    <div class="form-group">
                    ...
                    <select name="agama" id="agama" class="form-control-use">
                      ...
                      <option value="kristen">Buddha</option>
                    ...
                    if ($textarea) {
                        echo "<strong>Biografi:</strong> {$textarea} </br>";
                    }
                    ?>
                  </form>
                </div>
